class Buttons:
    ...
    def __init__(self, button_name, x, y, func):
        self.name = button_name
        self.x_pos = x
        self.y_pos = y
        self.func = print("placeholder")
    ...
    def draw(self, mouse, pygame, window, button_font, clicked):
        ...
        if self.x_pos <= mouse[0] <= self.y_pos+140 and self.y_pos <= mouse[1] <= self.y_pos+40 and clicked == True:
            self.func
